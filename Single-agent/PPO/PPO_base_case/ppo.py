...
class PPO:
  ...
  def __init__(self):
    ...
    self.cov_var = torch.full(size=(self.act_dim,), fill_value=0.5) # Initialise covariance matrix
  ...
  def learn(self, total_timesteps):
    ...
    while self.t_so_far < total_timesteps:    
      ...
      batch_obs, batch_acts, batch_log_probs, batch_rtgs, batch_lens = self.rollout(obs)
  ...
  def _init_hyperparameters(self):
    ...
    self.restart = 0 #Restart or not

    #Bump parameters
    self.bump_center = 100
    self.bump_radius_init = 25.58
