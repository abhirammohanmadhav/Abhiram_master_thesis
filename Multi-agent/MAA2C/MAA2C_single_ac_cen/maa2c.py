...
class MAA2C:
  ...
  # "total_timesteps" is set as a command by the user
  ...
  def get_action(self, obs, agent):
    ...
    #Denormalize radius
    #if agent==1:
    #   radius_denorm_1 = obs[0]*(self.bump_radius_max-self.bump_radius_min)+self.bump_radius_min
    #else:
    #   radius_denorm_1 = obs[0]*(self.bump_radius_max-self.bump_radius_min)+self.bump_radius_min
  ...
  def evaluate(self, batch_obs, batch_acts):
    ...
    V = self.critic(batch_obs).squeeze() #For example, calling squeeze on [[1], [2], [3]] will return [1, 2, 3]
